...
using static WebApplication1.Controllers.BreakfastFireForget;
...
namespace WebApplication1.Controllers
{
    ...
    [ApiController]
    public class DoBreakfastFireForget : ControllerBase
    {
        private readonly WebPubSubServiceClient _webPubSubServiceClient;
        private readonly IConfiguration _configuration;

        public DoBreakfastFireForget(IConfiguration configuration)
        {
        ...
        public async Task<IEnumerable<string>> GetAsync()
        {
            ...
            int num = rnd.Next();
            DoFireForget(num.ToString());

            return new string[] { "value1", "value2" };
        }

        private async void DoIndependentLongWork2(string tranIdentifier)
        {

            _webPubSubServiceClient.SendToAll(tranIdentifier + " Starting Fire and Forget Breakfast Preparation.....");
            Console.WriteLine(tranIdentifier + "Working...");
            await Task.Delay(10000);
            //object value = await new TimeSpan(0, 0, 0, 1);
            Thread.Sleep(1000); //will sleep for 5 sec
            _webPubSubServiceClient.SendToAll(tranIdentifier + " Fire and Forget Breakfast Prep Done.");

          //  return "done";
        }

        private async void DoFireForget(string tranIdentifier)
        {

            _webPubSubServiceClient.SendToAll(tranIdentifier +" Starting Stopwatch....");
         ...
         //   _webPubSubServiceClient.SendToAll("starting eggs, bacon and toast asyncronously....");
            ...
            while (breakfastTasks.Count > 0)
            {
                ...
                cntCur = breakfastTasks.Count;
                  ...
                  if (cntCur != cntStart)
                {
                    _webPubSubServiceClient.SendToAll(tranIdentifier + " Preparing....");
                    cntStart = cntCur;
                }
           ...
           // _webPubSubServiceClient.SendToAll("oj is ready");
            _webPubSubServiceClient.SendToAll(tranIdentifier + " <strong>Breakfast is ready!</strong>");
          ...
          //  Console.WriteLine("RunTime " + elapsedTime);
            ...
            _webPubSubServiceClient.SendToAll(tranIdentifier + " RunTime " + elapsedTime);

        }
    }


    static class BreakfastFireForget
    {
